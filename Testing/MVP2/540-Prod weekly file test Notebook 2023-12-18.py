...
dfg= spark.read.csv("/mnt/data/manonmani.varadharajan@kroger.com/weekly_sales/101_Weekly_Sales.540.20231217055446.csv",header=True)
...
sfile1=spark.sql("select path,name from vw_rawFileList where name like '101_Daily_Sales.540.%'")
