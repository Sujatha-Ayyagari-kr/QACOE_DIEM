...
# MAGIC %fs ls /mnt/data/release/daily_sales/landing_archive/2023_12_20/csv/
...
# MAGIC %fs ls /mnt/gold/release/sales/2024_01_21/csv/

# COMMAND ----------

dfg= spark.read.csv("/mnt/gold/release/sales/2024_01_21/csv/101_Weekly_Sales.029.20240121123447.csv",header=True)
dfg.createOrReplaceTempView("gld_vw")

# COMMAND ----------

# MAGIC %sql select count(1) from gld_vw
...
rawFolderpath1="/mnt/data/release/daily_sales/landing_archive/2024_01_15/csv/"
rawFolderpath2="/mnt/data/release/daily_sales/landing_archive/2024_01_16/csv/"
rawFolderpath3="/mnt/data/release/daily_sales/landing_archive/2024_01_17/csv/"
rawFolderpath4="/mnt/data/release/daily_sales/landing_archive/2024_01_18/csv/"
rawFolderpath5="/mnt/data/release/daily_sales/landing_archive/2024_01_19/csv/"
rawFolderpath6="/mnt/data/release/daily_sales/landing_archive/2024_01_20/csv/"
rawFolderpath7="/mnt/data/release/daily_sales/landing_archive/2024_01_21/csv/"
...
#select path,name from vw_rawFileList1 where name like '101_Daily_Sales.014.%' union all
sfile1=spark.sql("select path,name from vw_rawFileList1 where name like '101_Daily_Sales.029.%' union all select path,name from vw_rawFileList2 where name like '101_Daily_Sales.029.%' union all select path,name from vw_rawFileList3 where name like '101_Daily_Sales.029.%' union all select path,name from vw_rawFileList4 where name like '101_Daily_Sales.029.%' union all select path,name from vw_rawFileList5 where name like '101_Daily_Sales.029.%' union all select path,name from vw_rawFileList6 where name like '101_Daily_Sales.029.%' union all select path,name from vw_rawFileList7 where name like '101_Daily_Sales.029.%'")
...
for row in sfileCollect:
    ...
    idx = (cdt.weekday() ) % 7 # MON = 0, SUN = 6 -> SUN = 0 .. SAT = 6
    #print(idx)
...
dfaggdiff=spark.sql("select  sum(cast(POS_NET_DOL_AMOUNT as decimal(38,3))) , sum(cast(POS_UOM_QTY as decimal(18,4))), sum(POS_UNITS) from src_vw minus select sum(cast(POS_NET_DOL_AMOUNT as decimal(38,3))),sum(cast(POS_UOM_QTY as decimal(18,4))), sum(POS_UNITS) from gld_vw")
dfsaggunion=spark.sql("select 'src' as tabnm, sum(cast(POS_NET_DOL_AMOUNT as decimal(38,3))),sum(cast(POS_UOM_QTY as decimal(18,4))), sum(POS_UNITS) from src_vw union all select 'gld' as tabnm, sum(cast(POS_NET_DOL_AMOUNT as decimal(38,3))),sum(cast(POS_UOM_QTY as decimal(18,4))), sum(POS_UNITS) from gld_vw")
...
# MAGIC %sql select 'src' as tabnm, sum(cast(POS_NET_DOL_AMOUNT as decimal(38,3))),sum(cast(POS_UOM_QTY as decimal(18,4))), sum(POS_UNITS) from src_vw where store='00335' union all select 'gld' as tabnm, sum(cast(POS_NET_DOL_AMOUNT as decimal(38,3))),sum(cast(POS_UOM_QTY as decimal(18,4))), sum(POS_UNITS) from gld_vw where store='00335'
...
# MAGIC %sql select sum(POS_NET_DOL_AMOUNT) from vw_union where ITEM_CONSUMER_UPC='0002840051647' and STORE='00118'

# COMMAND ----------

# MAGIC %sql select * from vw_union where ITEM_CONSUMER_UPC='0002840051647' and STORE='00118'

# COMMAND ----------

# MAGIC %sql select * from gld_vw where ITEM_CONSUMER_UPC='0002840051647' and STORE='00118'

# COMMAND ----------

# MAGIC %sql select * from vw_union where ITEM_CONSUMER_UPC='0010000033666' and STORE='00118'

# COMMAND ----------

# MAGIC %sql select sum(POS_NET_DOL_AMOUNT) from vw_union where ITEM_CONSUMER_UPC='0010000033666' and STORE='00118'

# COMMAND ----------

# MAGIC %sql select * from gld_vw where ITEM_CONSUMER_UPC='0010000033666' and STORE='00118'

# COMMAND ----------

# MAGIC %sql select * from vw_union where ITEM_CONSUMER_UPC='0010000015342' and STORE='00202'

# COMMAND ----------

# MAGIC %sql select * from gld_vw where ITEM_CONSUMER_UPC='0010000015342' and STORE='00202'
