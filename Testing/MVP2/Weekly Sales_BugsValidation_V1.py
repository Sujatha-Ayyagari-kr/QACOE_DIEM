...
dfg= spark.read.csv("/mnt/data/manonmani.varadharajan@kroger.com/weekly_sales/101_Weekly_Sales.016.20240107120237.csv",header=True)
...
# MAGIC %sql select DIV,STORE,ITEM_CONSUMER_UPC,POS_DATE,cast(POS_NET_DOL_AMOUNT as decimal (38,4)),cast(POS_UOM_QTY as decimal (4,2)),cast(POS_UNITS as decimal),POS_UOM from src_vw minus select lpad(DIV,3,'0'),lpad(STORE,5,'0'),lpad(ITEM_CONSUMER_UPC,13,'0'),POS_DATE,cast(POS_NET_DOL_AMOUNT as decimal (38,4)),cast(POS_UOM_QTY as decimal (4,2)),cast(POS_UNITS as decimal),POS_UOM from gld_vw

# COMMAND ----------

# MAGIC %sql select 'raw' as tabnm,DIV,STORE,ITEM_CONSUMER_UPC,cast(POS_NET_DOL_AMOUNT as decimal (8,3)),cast(POS_UOM_QTY as decimal (4,2)),cast(POS_UNITS as decimal),POS_UOM,ITEM_SRC_DIV from src_vw where ITEM_CONSUMER_UPC='0004920090596'

# COMMAND ----------

# MAGIC %sql select 'gld' as tabnm,lpad(DIV,3,'0'),lpad(STORE,5,'0'),lpad(ITEM_CONSUMER_UPC,13,'0'),cast(POS_NET_DOL_AMOUNT as decimal (8,3)),cast(POS_UOM_QTY as decimal (4,2)),cast(POS_UNITS as decimal),POS_UOM,ITEM_SRC_DIV from gld_vw where lpad(ITEM_CONSUMER_UPC,13,'0')='0004920090596'
...
# MAGIC from
# MAGIC (
# MAGIC select 'raw' as tabnm,DIV,STORE,ITEM_CONSUMER_UPC,cast(POS_NET_DOL_AMOUNT as decimal (8,3)) as POS_NET_DOL_AMOUNT,cast(POS_UOM_QTY as decimal (4,2))  as POS_UOM_QTY,cast(POS_UNITS as decimal) as POS_UNITS,POS_UOM,ITEM_SRC_DIV from src_vw where ITEM_CONSUMER_UPC='0004920090596'
# MAGIC union all 
# MAGIC select 'gld' as tabnm,lpad(DIV,3,'0') as DIV,lpad(STORE,5,'0') as STORE,lpad(ITEM_CONSUMER_UPC,13,'0') as ITEM_CONSUMER_UPC,cast(POS_NET_DOL_AMOUNT as decimal (8,3)) as POS_NET_DOL_AMOUNT,cast(POS_UOM_QTY as decimal (4,2)) as POS_UOM_QTY,cast(POS_UNITS as decimal) as POS_UNITS,POS_UOM,ITEM_SRC_DIV from gld_vw where lpad(ITEM_CONSUMER_UPC,13,'0')='0004920090596'
...
# MAGIC %sql select DIV,STORE,ITEM_CONSUMER_UPC,cast(POS_NET_DOL_AMOUNT as decimal (8,3)),cast(POS_UOM_QTY as decimal (4,2)),cast(POS_UNITS as decimal),POS_UOM,ITEM_SRC_DIV from src_vw where ITEM_CONSUMER_UPC='0004920090596' and STORE='00128'
# MAGIC minus 
# MAGIC select lpad(DIV,3,'0') as DIV,lpad(STORE,5,'0') as STORE,lpad(ITEM_CONSUMER_UPC,13,'0') as ITEM_CONSUMER_UPC,cast(POS_NET_DOL_AMOUNT as decimal (8,3)) as POS_NET_DOL_AMOUNT,cast(POS_UOM_QTY as decimal (4,2)) as POS_UOM_QTY,cast(POS_UNITS as decimal) as POS_UNITS,POS_UOM,ITEM_SRC_DIV from gld_vw where lpad(ITEM_CONSUMER_UPC,13,'0')='0004920090596' and lpad(STORE,5,'0')='00128'
# MAGIC
...
# MAGIC select lpad(DIV,3,'0') as DIV,lpad(STORE,5,'0') as STORE,lpad(ITEM_CONSUMER_UPC,13,'0') as ITEM_CONSUMER_UPC,cast(POS_NET_DOL_AMOUNT as decimal (8,3)) as POS_NET_DOL_AMOUNT,cast(POS_UOM_QTY as decimal (4,2)) as POS_UOM_QTY,cast(POS_UNITS as decimal) as POS_UNITS,POS_UOM,ITEM_SRC_DIV from gld_vw where lpad(ITEM_CONSUMER_UPC,13,'0')='0004920090596' and lpad(STORE,5,'0')='00128'
# MAGIC minus
# MAGIC select DIV,STORE,ITEM_CONSUMER_UPC,cast(POS_NET_DOL_AMOUNT as decimal (8,3)),cast(POS_UOM_QTY as decimal (4,2)),cast(POS_UNITS as decimal),POS_UOM,ITEM_SRC_DIV from src_vw where ITEM_CONSUMER_UPC='0004920090596' and STORE='00128'

# COMMAND ----------

# MAGIC %sql select 'raw' as tabnm,DIV,STORE,ITEM_CONSUMER_UPC,cast(POS_NET_DOL_AMOUNT as decimal (8,3)),cast(POS_UOM_QTY as decimal (4,2)),cast(POS_UNITS as decimal),POS_UOM,ITEM_SRC_DIV from src_vw where ITEM_CONSUMER_UPC='0004920090596' and STORE='00128'
# MAGIC union all 
# MAGIC select 'gld' as tabnm,lpad(DIV,3,'0') as DIV,lpad(STORE,5,'0') as STORE,lpad(ITEM_CONSUMER_UPC,13,'0') as ITEM_CONSUMER_UPC,cast(POS_NET_DOL_AMOUNT as decimal (8,3)) as POS_NET_DOL_AMOUNT,cast(POS_UOM_QTY as decimal (4,2)) as POS_UOM_QTY,cast(POS_UNITS as decimal) as POS_UNITS,POS_UOM,ITEM_SRC_DIV from gld_vw where lpad(ITEM_CONSUMER_UPC,13,'0')='0004920090596' and lpad(STORE,5,'0')='00128'
